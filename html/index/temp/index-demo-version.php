...
<body>
<div id="container">
  <h1>Welcome to harisrozak web demo!</h1>
  <div id="breadcrumbs">
    <!--<p>This <strong><? print $host; ?></strong> has been successfully installed on the server.<br />
    ...
    <p>This page contains demo version of harislab works. <br>For more detail, please email me at <strong>harisrozak[at]gmail.com</strong></p>
  </div>
  <div id="listingcontainer">
	...
	if($dirok) {
	?>
      <div><a href="<?=$dotdotdir;?>" class="<?=$class;?>"><img src="index/dirup.png" alt="Folder" /><strong>..</strong> <em>-</em>
	...
	for($i=0;$i<$arsize;$i++) {
	?>
      <div><a href="<?=$leadon.$dirs[$i];?>" class="<?=$class;?>"><img src="index/folder.png" alt="<?=$dirs[$i];?>" /><strong>
        <?=$dirs[$i];?>
        </strong> <em>-</em>
	...
	?>
      <div><a href="<?=$fileurl;?>" class="<?=$class;?>"<?=$thumb2;?>><img src="index/icon/<?=$icon;?>" alt="<?=$files[$i];?>" /><strong>
        <?=$filename;?>
        </strong> <em>
